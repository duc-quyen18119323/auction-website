        ...
        <div class="bg-white rounded-xl shadow-xl p-8">
                    ...
                    <table class="min-w-full table-auto">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-100 to-gray-200">
                                ...
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Số tiền đấu giá</th>
                            ...
                            @foreach($bids as $index => $bid)
                                <tr class="hover:bg-blue-50 transition-all duration-300 fade-in-row" data-delay="{{ $index * 0.05 }}" style="opacity: 0;">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($bid->product)
                                            <a href="{{ url('/products/' . $bid->product->id) }}" class="text-blue-600 hover:text-blue-800 font-semibold hover:underline transition-colors">
                                                <i class="fas fa-box mr-2"></i>{{ $bid->product->name }}
                                            </a>
                                        @else
                                            <span class="text-gray-400 italic"><i class="fas fa-trash mr-2"></i>[Đã xóa]</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('products.index') }}" class="inline-block mt-6 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
